...
console.log('Connecting with pwd : '+process.env.MONGO_PASSWORD);
mongoose.connect
  (
    `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@cluster0.srzze.mongodb.net/${process.env.MONGO_DATABASE}?retryWrites=true&w=majority`,
